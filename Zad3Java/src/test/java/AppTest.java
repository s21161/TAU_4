...
public class AppTest {
    @Test
    public void checkFractionsEqualTrue() {
    ...
    public void checkFractionsOneHalfFractionOfEquals() {
        assertThat(Fraction.of(3, 1), is(equalTo(new Fraction(1, 3))));
    }
    ...
    public void checkFractionsMultiply() {
        ...
        assertThat(firstFraction.multiply(firstFraction, secondFraction).toString(), is("1/9"));
    }

    @Test
    public void checkFractionsNegativeMultiply() {
        Fraction firstFraction = new Fraction(-11, 10);
        Fraction secondFraction = new Fraction(2, 7);
        assertThat(firstFraction.multiply(firstFraction, secondFraction).toString(), is("22/-70"));
    }
